...
class StrEqual {
public:
  bool operator()(string v1, string v2) const { return v1 == v2; }
};
...
typedef hash_map<ULINT,ULINT,ULIntHash,ULIntEqual> ULINT2ULINTMap;

typedef hash_map<ULINT,LINT,ULIntHash,ULIntEqual> ULINT2LINTMap;
...
typedef hash_map<string,ULINT,StrHash,StrEqual> Str2ULINTMap;
...
typedef hash_map<ULINT,vector<ULINT>*,ULIntHash,ULIntEqual> ULINT2ULINTVMap;
